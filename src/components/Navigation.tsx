    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-700 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="text-xl md:text-2xl font-bold relative group flex-shrink-0">
          ...
          <button
            className="lg:hidden text-white p-3 rounded-xl border border-gray-700 hover:border-cyan-400 transition-all duration-500 hover:shadow-[0_0_20px_rgba(0,255,255,0.3)] relative group"
          ...
          <div className="lg:hidden bg-gray-900/95 backdrop-blur-2xl rounded-2xl mb-4 border border-gray-700 overflow-hidden animate-fade-in">
            ...
            {navItems.map((item, index) => (
              <a
                key={item.href}
                href={item.href}
                className="block px-6 py-4 text-gray-300 hover:text-cyan-400 hover:bg-gray-800/50 transition-all duration-500 font-medium relative group"
