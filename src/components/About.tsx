    ...
    <section id="about" className="py-12 sm:py-16 md:py-20 px-4 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <div className="w-16 sm:w-24 h-0.5 bg-gradient-to-r from-cyan-400 to-blue-400 mx-auto mt-4"></div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="relative">
              <div className="absolute -left-2 sm:-left-4 top-0 w-1 h-full bg-gradient-to-b from-cyan-400 to-blue-400"></div>
              <div className="pl-4 sm:pl-8 space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="group relative overflow-hidden">
                <div className="bg-gray-900/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-gray-700 hover:border-cyan-400/50 transition-all duration-300 group-hover:shadow-[0_0_30px_rgba(0,255,255,0.1)]">
          ...
          <div className="relative mt-4 sm:mt-0">
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl p-6 sm:p-8 rounded-2xl border border-gray-700 hover:border-cyan-400/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(0,255,255,0.1)] group">
              {/* Corner decorations */}
              <div className="absolute top-4 right-4 w-6 sm:w-8 h-6 sm:h-8 border-t-2 border-r-2 border-cyan-400/30"></div>
              <div className="absolute bottom-4 left-4 w-6 sm:w-8 h-6 sm:h-8 border-b-2 border-l-2 border-cyan-400/30"></div>
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  <div className="relative pl-6">
                    ...
                    <h4 className="text-lg sm:text-xl font-semibold text-cyan-400 mb-2">
